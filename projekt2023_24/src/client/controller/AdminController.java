...
public class AdminController {
    ...
    public AdminController(TCPClientFX tcpClientFX, Employee employee, List<Employee> employees, List<Order> orders) {
        this.tcpClientFX = tcpClientFX;
        this.employee = employee;
        this.employees = employees;
        this.orders = orders;
    ...
    private void addEmployeesTab() {
        ...
        employeesTable.getColumns().addAll(idColumn, nameColumn, lastNameColumn, roleColumn, zoneColumn);
